...
def load_model1(ckpt_dir):
    ...
    censor_dir = os.path.join(ckpt_dir, "model1_baseline", "censor")
    halluc_dir = os.path.join(ckpt_dir, "model1_baseline", "hallucinator")
...
def load_model2(ckpt_dir):
    ...
    censor_dir = os.path.join(ckpt_dir, "model2_advanced", "censor")
    halluc_dir = os.path.join(ckpt_dir, "model2_advanced", "hallucinator")
...
def load_model3(ckpt_dir):
    ...
    censor_dir = os.path.join(ckpt_dir, "model1_baseline", "censor")
    halluc_dir = os.path.join(ckpt_dir, "model1_baseline", "hallucinator")
    reph_dir = os.path.join(ckpt_dir, "model3_rephraser", "rephraser")

    # Fallback: if run_model13 saved censor under model3 too
    if not os.path.exists(censor_dir):
        censor_dir = os.path.join(ckpt_dir, "model3_rephraser", "censor")
        halluc_dir = os.path.join(ckpt_dir, "model3_rephraser", "hallucinator")
...
def load_model4(ckpt_dir):
    ...
    para_dir = os.path.join(ckpt_dir, "model4_semantic", "paraphraser")
